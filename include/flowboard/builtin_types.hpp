...
/// \file
/// \brief Type tags for the engine's built-in (primitive) message types.
///
/// These are the types a port can carry out of the box. Plugins should use
/// these types for their ports so the host can wire them and stream their live
/// values without any extra registration (see docs/PLUGINS.md).
